...
<script>
function clear_input(y_type) {
	  document.getElementById(y_type).value = '';
}
</script>
<script>
function cl1(elem) {
...
<p>
<b><font size=5>A</font>. </b>
<b>How to search MEDLINE/PubMed using the PICO format 
<br>(<font color="Red">P</font>: Patient or Problem; <font color="Red">I</font>: Intervention; <font color="Red">C</font>: Comparison; <font color="Red">O</font>: Outcome) 
<br>or<br>
<b><font size=5>B</font>. </b>How to create a well-built clinical question:
</b>
<hr>

<form method="post" action="search3.php" name="query1" id="query1">

<table width="861" border="0" cellpadding="8" cellspacing="0">
<tr>
   <td COLSPAN="2">
	  <b><font size=5>A</font>. </b>
	 <B><font color="Red"><b>CLINICAL CASE/SCENARIO:</b></font>  Briefly describe the case.<br>
        <textarea name="like" id="like" cols="95" rows="4" wrap="VIRTUAL">
A 10-year old child with sudden onset of generalized abdominal pain. You would like to give the patient an analgesic but concerned that it might mask the diagnosis of acute appendicitis.
</textarea>
</td></tr>

<tr>
   <td colspan="1" width="400"><B><font color="Red"><b>PATIENT OR PROBLEM</b></font><br>
How would you describe a group of patients similar to you?  What are the most important characteristics of the patient?</B>
</td>
</tr>
<tr>
<td colspan="1" width="461"><textarea name="condition" id="condition" cols="50" rows="3" wrap="VIRTUAL">Acute abdominal pain</textarea>
</td></tr>

<tr>
   <td width="400"><B><font color="Red"><b>INTERVENTION, EXPOSURE, PROGNOSTIC FACTOR</b></font><br>
What main intervention are you considering?  What do you want to do with this patient? What diagnostic test are you planning to do?</B></td>

</tr>
<tr>
<td width="461"><textarea name="intervention" id="intervention" cols="50" rows="3" wrap="VIRTUAL">Analgesics</textarea>
</td></tr>

<tr> 
   <td width="400"><B><font color="Red"><b>COMPARISON (optional)</b></font><br>  
What is the main alternative being considered, if any?</B></td>
</tr>
<tr>
<td width="461"><textarea name="comparison" id="comparison" cols="50" rows="3" wrap="VIRTUAL"></textarea>
</td></tr>

<tr> 
   <td width="400"><B><font color="Red"><b>OUTCOME (optional)</b></font><br> 
What are you trying to accomplish, measure, improve or affect?</B> (Making your search too specific could limit results. If no citations are retrieved, try deleting this option.)</td>
</tr>
<tr>
<td width="461"><textarea name="outcome" id="outcome" cols="50" rows="3" wrap="VIRTUAL">Diagnosis of acute appendicitis</textarea>
</td></tr>

<tr>

<td colspan="1" valign="top" width="400"><B>
Publication type:</B>
<p>
<select name = "pubtype">
<option value = "0">Publication type
<option value = "1">Clinical Trial
<option value = "2">Meta-Analysis
<option value = "3">Randomized Controlled Trial
<option value = "4">Review
<option value = "5">Practice Guideline</option>
</select>
</td></tr>
...
<form name="query2" id="query2" method="post" action="newparser.php" >
<table width="861" border="0" cellpadding="8" cellspacing="0">
<tr> 
<td colspan="2"><b><font size=5>B</font>. </b>
<B><font color="Red"><b>The well-built clinical question is:<b></b></font></B>
</td></tr>

<tr>
  <td colspan="2"><textarea name="question" id="question" cols="95" rows="3" wrap="VIRTUAL">
In a child with acute abdominal pain, will analgesics obscure the diagnosis of acute appendicitis?
</textarea>
</td></tr>
<tr><td>
<font size="2">
...
<button class="g-recaptcha" 
        ...
        data-action='submit'>Search</button>
<i>ask</i>MEDLINE</b>
</td></tr>
